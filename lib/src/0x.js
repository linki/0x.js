...
var ZeroEx = (function () {
    ...
    function ZeroEx(provider, config) {
        ...
        this.token = new token_wrapper_1.TokenWrapper(this._web3Wrapper, this._getTokenTransferProxyAddressAsync.bind(this));
        var exchageContractAddressIfExists = _.isUndefined(config) ? undefined : config.exchangeContractAddress;
        this.exchange = new exchange_wrapper_1.ExchangeWrapper(this._web3Wrapper, this.token, exchageContractAddressIfExists);
